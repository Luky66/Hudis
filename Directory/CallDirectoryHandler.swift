...
//  Directory
//
//  Created by Lukas Bühler on 18.10.17.
...
class CallDirectoryHandler: CXCallDirectoryProvider {
    ...
    override func beginRequest(with context: CXCallDirectoryExtensionContext) {
        let allPhoneNumbers: [CXCallDirectoryPhoneNumber] = [ 41_00_000_00_00 ]
        let labels = [ "Meeee baby" ]
    ...
    private func addIdentificationPhoneNumbers(to context: CXCallDirectoryExtensionContext) throws {
        let phoneNumbers: [CXCallDirectoryPhoneNumber] = [ 0041445330182 ]
        let labels = [ "Büehli Gschäft" ]
